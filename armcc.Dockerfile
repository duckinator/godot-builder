...
RUN apt-get update -y && apt-get install -y curl git make unzip zip python3 python3-pip g++-6-arm-linux-gnueabihf && rm -rf /home/builder && adduser --disabled-password --gecos "" builder
